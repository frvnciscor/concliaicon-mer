...
with tab1:
    ...
    VARS_DEV = [
        ...
        ("Fe DTT (%)",    "fe_dtt",   "fe_dtt_mp",   "fe_dtt_cp"),
    ...
    cols_d = [c for c in [
        'mes', 'fe', 'fem', 'fe_dtt', 'p', 's', 'volumen', 'tonelaje', 'fino',
        'fe_mp', 'fem_mp', 'fe_dtt_mp', 'p_mp', 's_mp', 'volumen_mp', 'tonelaje_mp', 'fino_mp',
        'fe_cp', 'fem_cp', 'fe_dtt_cp', 'p_cp', 's_cp', 'volumen_cp', 'tonelaje_cp', 'fino_cp'
...
with tab2:
    ...
    bw = 0.4
    b1 = ax1.bar(pos - bw/2, ton_mod, bw, color=bar_color, label=f'Ton {modelo_sel}')
