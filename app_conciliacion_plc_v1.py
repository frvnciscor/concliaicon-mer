            ...
            if df_base.empty or 'fem_cp' not in df_base.columns or 'fem_mp' not in df_base.columns:
                ...
                with cq_col:
                    ...
                    st.download_button("⬇️ PNG Cuadrantes", png_cuad,
                                       f"cuadrantes_fem_plc_{mes_abr}.png",
        ...
        try:
            ...
            with col_m:
                ...
                st.download_button("⬇️ PNG Matriz", png_mat,
                                   f"matriz_plc_{mes_abr}.png", "image/png", key="dl_png_matriz")
            ...
            with dl_m1:
                st.download_button("⬇️ CSV Matriz (%)", csv_bytes(ct_pct.reset_index()),
                                   f"matriz_pct_plc_{mes_abr}.csv", "text/csv", key="dl_mat_csv")
            with dl_m2:
                st.download_button("⬇️ CSV Conteos", csv_bytes(ct_raw.reset_index()),
                                   f"matriz_raw_plc_{mes_abr}.csv", "text/csv", key="dl_mat_raw_csv")
