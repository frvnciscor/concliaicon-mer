...
with tab2:
    ...
    bw = 0.4
    b1 = ax1.bar(pos - bw/2, ton_mod, bw, color=bar_color,  alpha=0.85, label=f'Tonelaje {label_mod}')
    b2 = ax1.bar(pos + bw/2, ton_cp,  bw, color=col_cp,     alpha=0.85, label='Tonelaje CP')
    if show_annot:
