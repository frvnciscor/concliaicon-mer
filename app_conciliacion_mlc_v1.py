...
with tab4:
    ...
    with _cm1: cy0=st.slider("Ton. mín",min_value=0,max_value=5000,value=0,step=50,key="cmy0")
    with _cm2: cy1=st.slider("Ton. máx",min_value=100,max_value=20000,value=2000,step=50,key="cmy1")
    try:
    ...
    with _ca1: cay0=st.slider("Ton. mín",min_value=0,max_value=5000,value=0,step=100,key="cay0")
    with _ca2: cay1=st.slider("Ton. máx",min_value=1000,max_value=50000,value=15000,step=500,key="cay1")
    try:
...
with tab6:
    ...
    with _cq1: cutoff_q=st.slider("Corte FeM (%)",min_value=0.0,max_value=70.0,value=float(cutoff_fem),step=0.5,key="cq")
